...
melee_base = ["sever", "slice", "dismember", "fury"] #this and following lists are for assembling a list of proper permutations appropriate for combat style
